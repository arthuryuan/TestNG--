...
#include <testngppst/utils/OptionList.h>
#include <testngppst/utils/StringList.h>
#include <testngppst/utils/ConsoleState.h>
   ...
   , unsigned int usecs)
{
   ...
   switch (result) 
   {
      ...
      case TestCaseResultReporter::TR_UNKNOWN:
         throw Error(TESTNGPPST_INTERNAL_ERROR(3001));
         break;
   }  
}
...
#define LISTENER(name) testngppststdoutlistener_##name
